...
def test_complex_size_adjustment(get_processed_device_from_testfile: Callable[[str], Device]):
    ...
    assert isinstance(cluster_a, ICluster)
    ...
    assert isinstance(cluster_a.registers_clusters[0], IRegister)
    ...
    assert isinstance(cluster_a.registers_clusters[1], IRegister)
    ...
    assert isinstance(cluster_b, ICluster)
    ...
    assert isinstance(cluster_b.registers_clusters[0], IRegister)
    ...
    assert isinstance(cluster_b.registers_clusters[1], IRegister)
    ...
    assert isinstance(cluster_c, ICluster)
    ...
    assert isinstance(cluster_c.registers_clusters[0], IRegister)
    ...
    assert isinstance(cluster_c.registers_clusters[1], IRegister)
